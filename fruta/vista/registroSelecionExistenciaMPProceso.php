            ...
            if (isset($_REQUEST['SELECIONAREXISTENCIA'])) {
                ...
                echo '<script>
                    Swal.fire({
                        ...
                        location.href = "registroSelecionExistenciaMPProceso.php?op&id='.$id_dato.'&a='.$accion_dato.'";                            
                    })
                </script>';
            }
            if($SINO==0){
                ...
                foreach ($ARRAYIDCAJA as $ID) :
                    ...
                    if ($SINO == 0) {
                        ...
                        foreach ($ARRAYVEREXITENICA as $r) :
                            ...
                            //LLAMADA AL METODO DE REGISTRO DEL CONTROLADOR
                            $EXIMATERIAPRIMA_ADO->agregarEximateriaprimaProcesoNuevo($EXIMATERIAPRIMA);
